...
export const BowlRatingBadge = ({
  ...
  return (
    <span
      ...
      className={clsx(
        "inline-flex items-center gap-1.5 text-base font-semibold leading-none text-warning-500 dark:text-warning-400",
        className,
      )}
      role="group"
    >
      <Icon aria-hidden className="h-5 w-5 shrink-0" icon="solar:star-bold" />
